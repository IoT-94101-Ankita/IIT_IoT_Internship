...
def create_data():
    ...
    return "soil_moisture data is added successfully"
...
def delete_data():
    ...
    return f"moisture data of id {sensor_id} is deleted successfully"
@server.route('/soil_moisture/threshold', methods=['GET'])
def desplay_data():
    # create a select query
    query = "select * from soil_moisture where moisture_level<40;"
